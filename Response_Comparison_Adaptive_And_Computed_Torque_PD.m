...
[t_Adaptive_1, x_Adaptive_case1] = ode45(@Adpative_Control_Uncertainty, time, x_0);

m1 = 1; m2 = 1;
L1 = 1; L2 = 1;      
m1_U = 1 + 0.1; m2_U = 1 + 0.1;
[t_C_T_1, x_C_T_case1] = ode45(@PD_Computed_Torques_Uncertainty, time, x_0);

m1 = 1; m2 = 1;
L1 = 1; L2 = 1;      
m1_U = 1 + 0.1; m2_U = 1 + 0.1;
[t_PD_1, x_PD_case1] = ode45(@PD_Control_Uncertainty, time, x_0);

break;
figure(1)
plot(t_Adaptive_1,rad2deg(x_Adaptive_case1(:,1)), 'r',...
     t_C_T_1,rad2deg(x_C_T_case1(:,1)), 'b',...
     t_PD_1,rad2deg(x_PD_case1(:,1)), 'k')
legend('Adaptive 1', 'PD+Computed Torque 2', 'PD');

figure(2)
plot(t_Adaptive_1,rad2deg(x_Adaptive_case1(:,2)), 'r',...
     t_C_T_1,rad2deg(x_C_T_case1(:,2)), 'b',...
     t_PD_1,rad2deg(x_PD_case1(:,2)), 'k')
legend('Adaptive 1', 'PD+Computed Torque 2', 'PD');
...
figure(1)
plot(t5,rad2deg(x_case5(:,1)), 'b', t6,rad2deg(x_case6(:,1)), 'r')
figure(2)
plot(t5,rad2deg(x_case5(:,2)), 'b', t6,rad2deg(x_case6(:,2)), 'r')
