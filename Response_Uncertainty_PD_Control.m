...
[t1, x_case1] = ode45(@PD_Control_Uncertainty, time, x_0);

% for case2의 경우
m1_U = 1 - 0.1; m2_U = 1 - 0.1;
L1_U = 1 - 0.1; L2_U = 1 - 0.1;
[t2, x_case2] = ode45(@PD_Control_Uncertainty, time, x_0);

% for case3의 경우
m1_U = 1 + 0.2; m2_U = 1 + 0.2;
L1_U = 1 + 0.2; L2_U = 1 + 0.2;

[t3, x_case3] = ode45(@PD_Control_Uncertainty, time, x_0);

% for case4의 경우
m1_U = 1 - 0.2; m2_U = 1 - 0.2;
L1_U = 1 - 0.2; L2_U = 1 - 0.2;
g = 9.81;
[t4, x_case4] = ode45(@PD_Control_Uncertainty, time, x_0);

% for case5의 경우
m1_U = 1 + 0.3; m2_U = 1 + 0.3;
L1_U = 1 + 0.3; L2_U = 1 + 0.3;
[t5, x_case5] = ode45(@PD_Control_Uncertainty, time, x_0);

% for case6의 경우
m1_U = 1 - 0.3; m2_U = 1 - 0.3;
L1_U = 1 - 0.3; L2_U = 1 - 0.3;
[t6, x_case6] = ode45(@PD_Control_Uncertainty, time, x_0);
