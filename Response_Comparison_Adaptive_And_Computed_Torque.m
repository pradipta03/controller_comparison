...
figure(1)
plot(t_Adaptive_1,rad2deg(x_Adaptive_case1(:,1)), 'b', t_C_T_1,rad2deg(x_C_T_case1(:,1)), 'r')
figure(2)
plot(t_Adaptive_1,rad2deg(x_Adaptive_case1(:,2)), 'b', t_C_T_1,rad2deg(x_C_T_case1(:,2)), 'r')
